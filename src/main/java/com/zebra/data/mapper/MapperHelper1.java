...
public class MapperHelper1 {
     ...
     * @param value
     */
	public static void notNullKeyProperty(String property, Object value) {
     ...
     * @return
     */
    public static Object getEntity(Map<String, Object> params) {
        Object result;
     ...
     * @return
     */
    public static MetaObject getExample(Map<String, Object> params) {
        Object result = null;
     ...
     * Example条件
     */
    public static void applyWhere(SQL sql, MetaObject example) {
        if (example == null) {
            return;
        }
     ...
     * Example条件
     */
    public static void applyOrderBy(SQL sql, MetaObject example, String defaultOrderByClause) {
        if (example == null) {
            return;
        }
    ...
    public static void applyWherePk(SQL sql, MetaObject metaObject, Set<EntityHelper.EntityColumn> columns, String suffix) {
